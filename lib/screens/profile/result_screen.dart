              ...
              child: Column(children: [
                ...
                Container(
                  ...
                  child: Column(children: [
                    ...
                    Text('${result.urgency.emoji} Prediksi Utama',
                      style: TextStyle(color: Colors.white.withOpacity(0.6), fontSize: 12,
                        fontFamily: 'Poppins')),
                    const SizedBox(height: 6),
                    Text(top?.disease ?? result.topDisease,
                    ...
                    Container(
                      ...
                      child: Row(mainAxisSize: MainAxisSize.min, children: [
                        Icon(Icons.warning_amber_rounded, color: _urgencyColor, size: 16),
                        const SizedBox(width: 6),
                        Text('${result.urgency.label} — ${result.urgency.action}',
                          style: TextStyle(color: _urgencyColor, fontWeight: FontWeight.w700,
                ...
                if (result.predictions.length > 1) ...[
                  _SectionCard(
                    ...
                    child: Column(
                      children: result.predictions.map((p) => _PredictionTile(p: p)).toList()),
                  ),
                  const SizedBox(height: 16),
                ],
                ...
                if (top != null && top.precautions.isNotEmpty) ...[
                  _SectionCard(
                    ...
                    color: AppTheme.primaryTeal,
                    child: Column(
                      children: top.precautions.map((p) => _BulletItem(
                        text: p, color: AppTheme.primaryTeal)).toList())),
                  const SizedBox(height: 16),
                ],
                  ...
                  _SectionCard(
                    ...
                    child: Column(
                      children: result.lifestyleRecommendation
                          .map((r) => _BulletItem(text: r, color: AppTheme.success))
                          .toList())),
                  const SizedBox(height: 16),
                ],
                ...
                if (result.urgency.description.isNotEmpty)
                  _SectionCard(
                    ...
                    color: _urgencyColor,
                    child: Text(result.urgency.description,
...
class _SectionCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Container(
    ...
    decoration: BoxDecoration(color: Colors.white,
      borderRadius: BorderRadius.circular(20), boxShadow: AppTheme.cardShadow),
    ...
    return Padding(
      ...
      child: Row(children: [
        ...
        Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          Text(p.disease, style: const TextStyle(fontSize: 13,
  ...
  Widget build(BuildContext context) => Padding(
    ...
    child: Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
      ...
      Expanded(child: Text(text, style: const TextStyle(fontSize: 13,
        color: AppTheme.textSecondary, fontFamily: 'Poppins', height: 1.5))),
    ]),
  );
}
